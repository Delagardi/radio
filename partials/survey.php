        ...
        <div class="ui form survey-radiobuttons">
            ...
            <div class="field">
                <div class="ui radio checkbox">
                    ...
                    <label class="ui label answer-label" for="independent">
                        Independent Radio
                    </label>
                </div>
            </div>
            <div class="field">
                <div class="ui radio checkbox">
                    ...
                    <label class="ui label answer-label" for="national">
                        National BBC Radio
                    </label>
                </div>
            </div>
            <div class="field">
                <div class="ui radio checkbox">
                    ...
                    <label class="ui label answer-label" for="midwest">
                        Mid West Radio
                    </label>
                </div>
            </div>
            <div class="field">
                <div class="ui radio checkbox">
                    ...
                    <label class="ui label answer-label" for="community">
                        Community Radio
                    </label>
                </div>
            </div>
            <div class="field">
                <div class="ui radio checkbox">
                    ...
                    <label class="ui label answer-label" for="other">
                        Other
                    </label>
                </div>
            </div>
